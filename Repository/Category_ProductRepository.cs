...
namespace Repository
{
    public class Category_ProductRepository : ICategory_ProductRepository
    {
        ...
        public async Task<Category_Product> UpdateCategory_Product(Category_Product category_product) => await Category_ProductDAO.Instance.UpdateCategory_Product(category_product);
